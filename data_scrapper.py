# Refernce for code below: https://medium.com/data-science-soccer-club/2020-21-transfer-window-data-scraping-with-python-b0ee406126f2
...
def get_data(pages):
    ...
    for page in range(1, pages+1):
        ...
        url  = f'https://www.transfermarkt.com/transfers/saisontransfers/statistik/top/plus/1/galerie/0?saison_id=2020&transferfenster=alle&land_id=&ausrichtung=&spielerposition_id=&altersklasse=&leihe=&page={page}'
